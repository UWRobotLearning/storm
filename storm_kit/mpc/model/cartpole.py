...
# from storm_kit.mpc.model.isaac_model import VecTask
...
if __name__ == "__main__":
    ...
    model = Cartpole(cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture=False, force_render=True)
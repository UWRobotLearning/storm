        ...
        for i in range(self.num_envs):
            ...
            if self.num_objects > 0:
                for j, object_asset in enumerate(object_assets):
                    ...
                    obj_props[0].friction = 0.1
                    obj_props[0].rolling_friction = 0.1  # default = 0.0
                    obj_props[0].torsion_friction = 0.1  # default = 0.0
            ...
            # exit()
            robot_props[-3].friction = 0.1 #for tray link
            robot_props[-3].rolling_friction = 0.1  # default = 0.0
            robot_props[-3].torsion_friction = 0.1  # default = 0.0
